...
import com.example.huertohogar.data.CategoryDao
...
class CategoryRepository(private val categoryDao: CategoryDao) {
    ...
    private fun getInitialCategories(): List<CategoryEntity>{
        return listOf(
            CategoryEntity(name = "Frutas Frescas", imageResName = "fruta", description = "Nuestra selección de frutas frescas ofrece una experiencia directa del campo a \n" +
            ...
            CategoryEntity(name = "Verduras Orgánicas", imageResName = "verdura", description = "Descubre nuestra gama de verduras orgánicas, cultivadas sin el uso de \n" +
            ...
            CategoryEntity(name = "Productos Orgánicos", imageResName = "organico", description = "Nuestros productos orgánicos están elaborados con ingredientes naturales y \n" +
            ...
            CategoryEntity(name = "Productos Lácteos", imageResName = "lacteos", description = "Los productos lácteos de HuertoHogar provienen de granjas locales que se \n" +
